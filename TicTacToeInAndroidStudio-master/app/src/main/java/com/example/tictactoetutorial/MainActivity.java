...
public class  MainActivity extends AppCompatActivity {
    ...
    private void initWidgets()
    {
        ...
        themeSwitch = findViewById(R.id.Swicher);
        parentView = findViewById(R.id.MainViewView);
    }
    ...
    {
        final int black = ContextCompat.getColor(this, R.color.teal_700);
        final int white = ContextCompat.getColor(this, R.color.teal_200);
